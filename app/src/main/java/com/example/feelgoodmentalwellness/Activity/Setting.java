        ...
        db.collection("User")
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        sharedPreferences.edit()
                                .putString(AppConfig.PROFILE_STATE,"com.example.feelgoodmentalwellness.PROFILE_STATE")
                                .putString(AppConfig.PROFILE_VISIBILITY,"com.example.feelgoodmentalwellness.PROFILE_VISIBILITY")
                                .putString(AppConfig.CALL_STATE,"com.example.feelgoodmentalwellness.CALL_STATE")
                                .putString(AppConfig.PROFILE_DP,"com.example.feelgoodmentalwellness.PROFILE_DP")
                                .apply();
                        if(state!=1) {
