...
import com.example.feelgoodmentalwellness.Adapter.MessageAdapter;
import com.example.feelgoodmentalwellness.Model.AppConfig;
import com.example.feelgoodmentalwellness.Model.MessageModel;
...
//                Log.d("SENDDATA", String.valueOf(map));
//                Log.d("SENDMAIL", mail + " " + mAuth.getCurrentUser().getEmail());
//                db.collection("User")
//                        .document(mail)
//                        .collection("Chat")
...
//                        }
    ...
    private void init() {
        ...
        db.collection("User")
                .document(Objects.requireNonNull(mail))
                .get()
                .addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                    @Override
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
